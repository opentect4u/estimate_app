export const reportHeaders = {
  ...
  pioreport: {
    ...
    headers: [
      ...
      { name: "invoice_no", value: "Invoice No." },
  ...
  employeewisereport: {
    ...
    headers: [
      ...
      // "gross_sale": 3785944,
      { name: "user_id", value: "User ID" },
      { name: "user_name", value: "Product name" },
      { name: "branch_name", value: "Store" },
      { name: "receipt_no_count", value: "No. of Receipt" },
      { name: "item_count", value: "No. of Products" },
      { name: "tot_round_off", value: "Round Off" },
      { name: "net_sale", value: "Net Sale" },
      { name: "gross_sale", value: "Gross Sale" },
      { name: "tot_round_off", value: "Round Off" },
      { name: "tot_cash_amt", value: "Cash" },
      { name: "tot_credit_amt", value: "Credit" },
