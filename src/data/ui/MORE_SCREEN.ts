...
export const MORE_SCREEN_DATA = [
  // { "text": "Refund Item", "icon": "cash-refund", "route": navigationRoutes.refundItemsScreen },
  { "text": "Search By Date", "icon": "text-box-search-outline", "route": navigationRoutes.searchBillsByDateScreen },
