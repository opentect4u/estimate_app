...
async def Productwise_report(item_rep:ItemReport):
    ...
    query = f"SELECT s.created_by as user_id,u.user_name from md_user u,td_item_sale where s.comp_id = {item_rep.comp_id} and s.trn_date BETWEEN '{item_rep.from_date}' and '{item_rep.to_date}'" 
