...
async def Productwise_report(item_rep:ItemReport):
    ...
    query = f"SELECT r.created_by as user_id,u.user_name from td_receipt r, md_user u where u.phone_no=r.created_by and r.comp_id = {item_rep.comp_id} and r.br_id={item_rep.br_id} r.trn_date BETWEEN '{item_rep.from_date}' and '{item_rep.to_date}'" 
