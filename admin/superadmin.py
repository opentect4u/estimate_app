...
async def add__edit_outlet(data:AddEditOutletS):
    ...
    cursor = conn.cursor()
    stock = 0
    query = f"insert into td_stock (comp_id,br_id,item_id,stock,created_by,created_dt) select '{data.comp_id},'{data.br_id}', item_id,{stock},'{data.created_by}','{formatted_dt}'"
